                            ...
                            >
                                <div className="vid__screen-overlay__side left">
                                    <div className="vid__screen-overlay__side-fill">
                                        <Link className="vid__screen-overlay__side-smalllink" to={`/videos/`}>
                                            Close
                                        </Link>
                                        <Link
                            ...
                            <div className="vid__controls-buttons">
                                ...
                                >
                                    {videoStates.isPlaying ? (
                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 41 41"> {" "} <g transform="translate(-1072 -991)"> {" "} <g transform="translate(1071 999.57)"> {" "} <rect width="0.72" height="19.394" transform="translate(17 2.43)" />{" "} <rect width="0.72" height="19.394" transform="translate(24.996 2.43)" />{" "} </g>{" "} <g strokeWidth="0.5" fill="none" transform="translate(1072 991)"> {" "} <circle stroke="none" cx="20.5" cy="20.5" r="20.5" />{" "} <circle fill="none" cx="20.5" cy="20.5" r="20.25" />{" "} </g>{" "} </g>{" "} </svg>
                                    ) : (
