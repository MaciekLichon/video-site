                ...
                <div className="vid__screen">
                    <div className="container-big">
                        <div className="vid__screen-content">
                            ...
                            >
                                <source src={`${videoDetails?.snippet}#t=0.01`} type="video/mp4" />
                            </video>
                            <div
                                className={`vid__screen-overlay ${isMobileOverlayVisible ? "vid__screen-overlay_mobile" : ""} ${videoStates.isPlaying ? "vid__screen-overlay_hidden" : ""}`}
                            ...
                            >
                                ...
                                <div className="vid__screen-overlay__side right">
                                    <div className="vid__screen-overlay__side-fill">
                                        ...
                                        >
                                            <svg xmlns="http://www.w3.org/2000/svg" width="800px" height="800px" viewBox="0 0 24 24" fill="none" > <path d="M12 17V11" stroke="white" strokeWidth="1.5" stroke-linecap="round" className="nofill" /> <circle cx="1" cy="1" r="1" transform="matrix(1 0 0 -1 11 9)" fill="white" /> <path d="M2 12C2 7.28595 2 4.92893 3.46447 3.46447C4.92893 2 7.28595 2 12 2C16.714 2 19.0711 2 20.5355 3.46447C22 4.92893 22 7.28595 22 12C22 16.714 22 19.0711 20.5355 20.5355C19.0711 22 16.714 22 12 22C7.28595 22 4.92893 22 3.46447 20.5355C2 19.0711 2 16.714 2 12Z" stroke="white" strokeWidth="1.5" className="nofill" /> </svg>
                                        </button>
                                        <Link
                                            className="vid__screen-overlay__side-videolink"
                            ...
                            <div className="vid__controls-buttons">
                                ...
                                >
                                    {videoStates.isPlaying ? (
                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 129 129"> {" "} <g transform="translate(-95 -85)"> {" "} <g transform="translate(94.969 84.969)"> {" "} <g transform="translate(0.031 0.031)" fill="none" stroke="rgba(77, 77, 77, 1)" strokeWidth="4" > {" "} <circle cx="64.5" cy="64.5" r="64.5" stroke="none" />{" "} <circle cx="64.5" cy="64.5" r="62.5" fill="none" />{" "} </g>{" "} </g>{" "} <g transform="translate(147 123)"> {" "} <rect width="1.989" height="53.605" transform="translate(0 0)" fill="rgba(77, 77, 77, 1)" stroke="rgba(77, 77, 77, 1)" stroke-linecap="round" strokeWidth="1" />{" "} <rect id="Rectangle_10" data-name="Rectangle 10" width="1.989" height="53.605" transform="translate(22.1 0)" fill="rgba(77, 77, 77, 1)" stroke="rgba(77, 77, 77, 1)" stroke-linecap="round" strokeWidth="1" />{" "} </g>{" "} </g>{" "} </svg>
                                    ) : (
                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 129 129"> {" "} <g transform="translate(-94 -85)"> {" "} <g transform="translate(93.969 84.969)"> {" "} <g transform="translate(0.031 0.031)" fill="none" stroke="rgba(77, 77, 77, 1)" strokeWidth="4" > {" "} <circle cx="64.5" cy="64.5" r="64.5" stroke="none" />{" "} <circle cx="64.5" cy="64.5" r="62.5" fill="none" />{" "} </g>{" "} </g>{" "} <g transform="translate(186.474 119.233) rotate(90)" fill=""> {" "} <path className="nofill" d="M 56.6093864440918 39.67949676513672 L 3.924065589904785 39.67949676513672 C 3.924075126647949 39.67949295043945 3.924072027206421 39.67948913574219 3.92406964302063 39.67948150634766 L 30.26672554016113 3.4037184715271 L 30.26708602905273 3.404218673706055 L 56.6093864440918 39.67948913574219 C 56.609375 39.67948532104492 56.60937118530273 39.67949295043945 56.60936737060547 39.67949676513672 L 56.6093864440918 39.67949676513672 Z" stroke="none" />{" "} <path d="M 30.26672744750977 6.807449340820312 L 7.848125457763672 37.67949295043945 L 52.68532562255859 37.67949295043945 L 30.26672744750977 6.807449340820312 M 30.26672554016113 1.403720855712891 C 30.87622833251953 1.403720855712891 31.48573112487793 1.678661346435547 31.88503646850586 2.228538513183594 L 58.22770309448242 38.50430679321289 C 59.18778228759766 39.8264045715332 58.24330139160156 41.67948150634766 56.60938262939453 41.67949295043945 L 3.924057006835938 41.67949295043945 C 2.290145874023438 41.67948150634766 1.345668792724609 39.8264045715332 2.305747985839844 38.50430679321289 L 28.64841461181641 2.228538513183594 C 29.04771995544434 1.678661346435547 29.65722274780273 1.403720855712891 30.26672554016113 1.403720855712891 Z" stroke="none" fill="rgba(77, 77, 77, 1)" />{" "} </g>{" "} </g>{" "} </svg>
                                    )}
                                </button>
