    ...
    return (
        <TransitionedPage>
            <section className={`vid ${videoStates.isFullScreen ? "vid_fullsize" : ""}`}>
                    ...
                    <div className="container-big">
                        <div className="vid__screen-content">
                            ...
                            >
                                ...
                                <div className="vid__screen-overlay__middle"></div>
                ...
                <div
                    className={`vid__controls ${isMobileOverlayVisible ? "vid__controls_hidden" : ""} ${
                        videoStates.isPlaying ? "vid__controls_fade" : ""
                    }`}
                >
                                        ...
                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 129 129">
                                            ...
                                            <g transform="translate(-94 -85)">
                                                ...
                                                <g transform="translate(186.474 119.233) rotate(90)" fill="">
                                                    ...
                                                    <path
                                                        className="nofill"
                                                        d="M 56.6093864440918 39.67949676513672 L 3.924065589904785 39.67949676513672 C 3.924075126647949 39.67949295043945 3.924072027206421 39.67948913574219 3.92406964302063 39.67948150634766 L 30.26672554016113 3.4037184715271 L 30.26708602905273 3.404218673706055 L 56.6093864440918 39.67948913574219 C 56.609375 39.67948532104492 56.60937118530273 39.67949295043945 56.60936737060547 39.67949676513672 L 56.6093864440918 39.67949676513672 Z"
                                                        stroke="none"
                                                    />{" "}
                                                    <path
                                                        d="M 30.26672744750977 6.807449340820312 L 7.848125457763672 37.67949295043945 L 52.68532562255859 37.67949295043945 L 30.26672744750977 6.807449340820312 M 30.26672554016113 1.403720855712891 C 30.87622833251953 1.403720855712891 31.48573112487793 1.678661346435547 31.88503646850586 2.228538513183594 L 58.22770309448242 38.50430679321289 C 59.18778228759766 39.8264045715332 58.24330139160156 41.67948150634766 56.60938262939453 41.67949295043945 L 3.924057006835938 41.67949295043945 C 2.290145874023438 41.67948150634766 1.345668792724609 39.8264045715332 2.305747985839844 38.50430679321289 L 28.64841461181641 2.228538513183594 C 29.04771995544434 1.678661346435547 29.65722274780273 1.403720855712891 30.26672554016113 1.403720855712891 Z"
                                                        stroke="none"
                                                        fill="rgba(77, 77, 77, 1)"
                                                    />{" "}
                                                </g>{" "}
                                ...
                                >
                                    {videoStates.isMuted ? (
                                        <svg
                                            ...
                                            width="120.443"
                                            height="120.309"
                                            viewBox="0 0 120.443 120.309"
                                        >
                                            {" "}
                                            <path
                                                id="volume-mute"
                                                d="M119.709,75.907a2.508,2.508,0,0,1-3.549,3.544L100.389,63.68,84.617,79.452a2.508,2.508,0,0,1-3.549-3.544L96.839,60.136,81.068,44.365a2.506,2.506,0,0,1,3.544-3.544l15.771,15.771L116.155,40.82a2.506,2.506,0,0,1,3.544,3.544L103.928,60.136,119.7,75.907ZM70.184,8.576v103.2a8.537,8.537,0,0,1-8.532,8.542,8.428,8.428,0,0,1-2.928-.521c-10.843-3.98-23.01-13.415-30.28-23.482l-.752-1.043-5.138-.015A22.624,22.624,0,0,1,0,72.664V47.628A22.55,22.55,0,0,1,22.554,25.069h.035l5.1.015.747-1.038C35.949,13.659,47.926,4.4,58.955.489A8.245,8.245,0,0,1,66.54,1.552a8.616,8.616,0,0,1,3.65,7.023Zm-5.013,0a3.6,3.6,0,0,0-1.524-2.928,3.27,3.27,0,0,0-3.013-.436C50.5,8.811,39.459,17.359,32.51,26.984l-1.5,2.08a2.515,2.515,0,0,1-2.035,1.043h-.005l-6.387-.015h-.025A17.544,17.544,0,0,0,5.018,47.638V72.674A17.6,17.6,0,0,0,22.569,90.25l6.422.015a2.5,2.5,0,0,1,2.025,1.043l1.5,2.08c6.627,9.179,18.118,18.1,27.943,21.712a3.514,3.514,0,0,0,4.717-3.314V8.576Z"
                                                transform="translate(0 -0.005)"
                                                fill="rgba(77, 77, 77, 1)"
                                            />{" "}
                                        </svg>
                                    ) : (
                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 130.734 120.099">
                                            {" "}
                                            <g transform="translate(-96 -89.617)">
                                                ...
                                                <g transform="translate(96 89.617)">
                                                    {" "}
                                                    <path
                                                        d="M75.072,8.561V111.577a8.522,8.522,0,0,1-8.518,8.528,8.413,8.413,0,0,1-2.923-.52c-10.825-3.974-22.97-13.4-30.227-23.441L32.654,95.1,22.52,95.087A22.585,22.585,0,0,1,0,72.542V47.55A22.52,22.52,0,0,1,22.52,25.03h.035l10.1.015.746-1.036C40.9,13.635,52.852,4.4,63.862.488a8.228,8.228,0,0,1,7.572,1.061,8.6,8.6,0,0,1,3.643,7.011Zm-5,0a3.59,3.59,0,0,0-1.521-2.923A3.266,3.266,0,0,0,65.538,5.2C55.419,8.8,44.4,17.328,37.463,26.937l-1.5,2.077a2.725,2.725,0,0,1-2.037,1.041L22.55,30.04h-.025A17.513,17.513,0,0,0,5.009,47.555V72.547A17.571,17.571,0,0,0,22.53,90.093l11.41.015a2.479,2.479,0,0,1,2.022,1.041l1.5,2.077c6.616,9.158,18.086,18.071,27.895,21.674a3.508,3.508,0,0,0,4.709-3.308V8.561Z"
                                                        transform="translate(0 -0.005)"
                                                        fill="rgba(77, 77, 77, 1)"
                                                    />{" "}
                                                </g>{" "}
                                                <path
                                                    d="M71.267,44.248a1.914,1.914,0,0,0,.189-2.69c-.606-.682-1.212-1.4-1.894-2.046a34.026,34.026,0,0,0-48.192,0c-.644.644-1.288,1.326-1.894,2.046a1.907,1.907,0,1,0,2.879,2.5c.53-.644,1.1-1.25,1.667-1.819a30.367,30.367,0,0,1,42.888,0c.606.606,1.137,1.212,1.667,1.819a1.827,1.827,0,0,0,1.44.644,1.956,1.956,0,0,0,1.25-.455ZM90.324,25.684a1.913,1.913,0,0,0,.152-2.69c-.682-.758-1.4-1.478-2.122-2.235A60.551,60.551,0,0,0,2.617,20.8c-.72.72-1.44,1.478-2.122,2.235a1.879,1.879,0,0,0,.152,2.69,1.913,1.913,0,0,0,2.69-.152c.644-.72,1.288-1.4,1.97-2.084a56.892,56.892,0,0,1,80.4,0c.682.682,1.326,1.364,1.97,2.084a1.877,1.877,0,0,0,1.4.644,1.744,1.744,0,0,0,1.25-.493Z"
                                                    transform="translate(229.724 103.522) rotate(90)"
                                                    fill="rgba(77, 77, 77, 1)"
                                                />{" "}
                                            </g>{" "}
                                        </svg>
